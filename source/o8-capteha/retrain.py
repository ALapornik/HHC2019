# This file was downloaded from the following repository:
# https://github.com/chrisjd20/img_rec_tf_ml_demo
#  
# Modifications made to the file consisted of changing references to the 
# tmp folder from an absolute path to a relative path within the project 
# folder.
#
# This file was used to train the Machine Learning model we used to solve 
# the CAPTEHA challenge that was part of the Kringlecon 2019 event.
#   
# Command line from PowerShell
# (.venv) PS> python retrain.py --image_dir .\training_images\ --tfhub_module https://tfhub.dev/google/imagenet/mobilenet_v1_100_224/feature_vector/3
# ==============================================================================
